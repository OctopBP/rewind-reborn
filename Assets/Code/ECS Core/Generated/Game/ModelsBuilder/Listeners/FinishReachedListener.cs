...
public class FinishReachedListener : IGameComponentListener, IFinishReachedListener {
    [SerializeField] List<Component> listeners = new();

	public void Validate() {
		listeners = listeners.Where(m => m is IFinishReachedListener).ToList();
	}
	...
	public void OnFinishReached(GameEntity entity) =>
		listeners.ForEach(l => ((IFinishReachedListener) l).OnFinishReached(entity));
}