...
public partial class GameContext {
    ...
    public GameEntity SetTime(Rewind.Services.ITimeService newValue) {
        if (hasTime) {
    ...
    public void ReplaceTime(Rewind.Services.ITimeService newValue) {
...
public partial class GameEntity {
    ...
    public void AddTime(Rewind.Services.ITimeService newValue) {
